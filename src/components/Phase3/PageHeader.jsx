...
export default function PageHeader({ activeTimeframe = 'Overview', onTimeframeChange }) {
  const tabs = ['Overview', 'Monthly', 'Quarterly', 'YoY'];
      ...
      <div style={{ display: 'flex', backgroundColor: '#E2E8F0', borderRadius: '8px', padding: '3px' }}>
        {tabs.map((tab) => {
          ...
          return (
            <div 
              key={tab}
              onClick={() => onTimeframeChange && onTimeframeChange(tab)}
              style={{ 
